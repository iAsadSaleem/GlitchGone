    ...
    function buildThemeSelectorSection(container) {
        ...
        const themes = {
            ...
            "ForestGreen Theme": {
                ...
                "--sidebar-bg-color": "#253D2C",
                "--sidebar-menu-bg": "#1A2B21",
                "--sidebar-menu-color": "#FFFFFF",
                "--sidebar-menu-hover-bg": "#2E6F40",
                "--sidebar-menu-active-bg": "#1E4A32",
                "--sidebar-menu-icon-color": "#A8E6AB",
                ...
                "--header-icon-color": "#2E6F40",
                "--header-icon-hover-color": "#253D2C",
                "--header-icon-bg": "#CFFFDC",
                "--header-icon-hover-bg": "#A8E6AB",

                "--card-body-bg-color": "#FFFFFF",
                "--card-body-font-color": "#374151",
                "--card-title-font-color": "#1F3B28",
                ...
                "--card-header-gradient-end": "#2E6F40",

                "--card-body-border-color": "#A8E6AB",

                "--bg-gradient": "linear-gradient(90deg, #F2FFF6 0%, #CFFFDC 100%)",
                "--sidebar-main-bg-gradient": "linear-gradient(to bottom, #253D2C, #2E6F40)",
                "--login-card-bg-gradient": "linear-gradient(to bottom, #CFFFDC, #F2FFF6)",

                "--login-link-text-color": "#2E6F40",
                "--login-button-bg-gradient": "linear-gradient(to right, #68BA7F 0%, #2E6F40 100%)",
                "--login-button-bg-color": "#2E6F40",
                "--login-card-bg-color": "#FFFFFF",

                "--header-main-bg-gradient": "linear-gradient(90deg, #68BA7F 0%, #2E6F40 100%)",
                "--header-icon-hover": "#1F3B28",
            ...
            "ForestGreen Gold Theme": {
                ...
                "--sidebar-menu-hover-bg": "#2E6F40",
                "--sidebar-menu-active-bg": "#1E4A32",
                "--sidebar-menu-icon-color": "#F5D76E",
                "--sidebar-menu-icon-hover-color": "#D4AF37",
                "--sidebar-menu-icon-active-color": "#F5D76E",

                "--scroll-color": "#D4AF37",

                "--header-bg-color": "#F8FFF2",
                "--header-icon-color": "#2E6F40",
                "--header-icon-hover-color": "#D4AF37",
                "--header-icon-bg": "#CFFFDC",
                "--header-icon-hover-bg": "#F5D76E",

                "--card-body-bg-color": "#FFFFFF",
                "--card-body-font-color": "#374151",
                "--card-title-font-color": "#253D2C",
                "--card-dec-font-color": "#4B5563",
                "--card-footer-bg-color": "#F5D76E",
                "--card-footer-font-color": "#253D2C",

                "--top-nav-menu-bg": "#2E6F40",
                "--top-nav-menu-hover-bg": "#253D2C",
                "--top-nav-menu-active-bg": "#1E4A32",
                "--top-nav-menu-color": "#FFFFFF",
                "--top-nav-menu-hover-color": "#F5D76E",
                "--top-nav-menu-active-color": "#FFFFFF",

                "--card-header-gradient-start": "#68BA7F",
                "--card-header-bg-gradient": "linear-gradient(90deg, #68BA7F 0%, #2E6F40 50%, #D4AF37 100%)",
                "--card-header-gradient-end": "#D4AF37",

                "--card-body-border-color": "#D4AF37",

                "--bg-gradient": "linear-gradient(90deg, #F8FFF2 0%, #CFFFDC 60%, #F5D76E 100%)",
                "--sidebar-main-bg-gradient": "linear-gradient(to bottom, #253D2C, #2E6F40 70%, #D4AF37)",
                "--login-card-bg-gradient": "linear-gradient(to bottom, #CFFFDC, #F8FFF2, #F5D76E)",

                "--login-link-text-color": "#D4AF37",
                "--login-button-bg-gradient": "linear-gradient(to right, #2E6F40 0%, #68BA7F 60%, #D4AF37 100%)",
                "--login-button-bg-color": "#2E6F40",
                "--login-card-bg-color": "#FFFFFF",

                "--header-main-bg-gradient": "linear-gradient(90deg, #2E6F40 0%, #68BA7F 50%, #D4AF37 100%)",
            ...
            "Lilac Silver Theme": {
                ...
                "--sidebar-bg-color": "#332736",
                "--sidebar-menu-bg": "#2A212D",
                "--sidebar-menu-color": "#FFFFFF",
                "--sidebar-menu-hover-bg": "#5B455E",
                "--sidebar-menu-active-bg": "#46364A",
                "--sidebar-menu-icon-color": "#C0C0C0",
                "--sidebar-menu-icon-hover-color": "#D9D9D9",
                "--sidebar-menu-icon-active-color": "#FFFFFF",

                "--scroll-color": "#C0C0C0",

                "--header-bg-color": "#F7F2F8",
                "--header-icon-color": "#5B455E",
                "--header-icon-hover-color": "#C0C0C0",
                "--header-icon-bg": "#E6DBEC",
                "--header-icon-hover-bg": "#C0C0C0",

                "--card-body-bg-color": "#FFFFFF",
                "--card-body-font-color": "#403545",
                "--card-title-font-color": "#332736",
                "--card-dec-font-color": "#6F6173",
                "--card-footer-bg-color": "#E6DBEC",
                "--card-footer-font-color": "#332736",

                "--top-nav-menu-bg": "#5B455E",
                "--top-nav-menu-hover-bg": "#46364A",
                "--top-nav-menu-active-bg": "#332736",
                "--top-nav-menu-color": "#FFFFFF",
                "--top-nav-menu-hover-color": "#C0C0C0",
                "--top-nav-menu-active-color": "#FFFFFF",

                "--card-header-gradient-start": "#826387",
                "--card-header-bg-gradient": "linear-gradient(90deg, #826387 0%, #5B455E 50%, #C0C0C0 100%)",
                "--card-header-gradient-end": "#C0C0C0",

                "--card-body-border-color": "#C0C0C0",

                "--bg-gradient": "linear-gradient(90deg, #FBF8FC 0%, #F7F2F8 60%, #E6DBEC 100%)",
                "--sidebar-main-bg-gradient": "linear-gradient(to bottom, #332736, #5B455E 80%, #C0C0C0)",
                "--login-card-bg-gradient": "linear-gradient(to bottom, #E6DBEC, #F7F2F8, #FFFFFF)",

                "--login-link-text-color": "#826387",
                "--login-button-bg-gradient": "linear-gradient(to right, #826387 0%, #5B455E 70%, #C0C0C0 100%)",
                "--login-button-bg-color": "#826387",
                "--login-card-bg-color": "#FFFFFF",

                "--header-main-bg-gradient": "linear-gradient(90deg, #826387 0%, #5B455E 50%, #C0C0C0 100%)",
                "--header-icon-hover": "#C0C0C0",
            ...
            "JetBlack Cyber Theme": {
                ...
                "--sidebar-menu-bg": "#1B1B1B",
                "--sidebar-menu-color": "#FFFFFF",
                "--sidebar-menu-hover-bg": "#333333",
                "--sidebar-menu-active-bg": "#3D3D3D",
                "--sidebar-menu-icon-color": "#CFCFCF",
                "--sidebar-menu-icon-hover-color": "#00D1FF",
                "--sidebar-menu-icon-active-color": "#00D1FF",

                "--scroll-color": "#00D1FF",

                "--header-bg-color": "#F0F0F0",
                "--header-icon-color": "#545454",
                "--header-icon-hover-color": "#00D1FF",
                "--header-icon-bg": "#D9D9D9",
                "--header-icon-hover-bg": "#00D1FF",

                "--card-body-bg-color": "#FFFFFF",
                "--card-body-font-color": "#3A3A3A",
                "--card-title-font-color": "#252525",
                "--card-dec-font-color": "#555555",
                "--card-footer-bg-color": "#D9D9D9",
                "--card-footer-font-color": "#252525",

                "--top-nav-menu-bg": "#545454",
                "--top-nav-menu-hover-bg": "#3A3A3A",
                "--top-nav-menu-active-bg": "#252525",
                "--top-nav-menu-color": "#FFFFFF",
                "--top-nav-menu-hover-color": "#00D1FF",
                "--top-nav-menu-active-color": "#FFFFFF",

                "--card-header-gradient-start": "#7D7D7D",
                "--card-header-bg-gradient": "linear-gradient(90deg, #7D7D7D 0%, #545454 50%, #00D1FF 100%)",
                "--card-header-gradient-end": "#00D1FF",

                "--card-body-border-color": "#CFCFCF",

                "--bg-gradient": "linear-gradient(90deg, #F5F5F5 0%, #E6E6E6 60%, #D9D9D9 100%)",
                "--sidebar-main-bg-gradient": "linear-gradient(to bottom, #252525, #545454 70%, #00D1FF)",
                "--login-card-bg-gradient": "linear-gradient(to bottom, #D9D9D9, #F0F0F0, #FFFFFF)",

                "--login-link-text-color": "#00D1FF",
                "--login-button-bg-gradient": "linear-gradient(to right, #545454 0%, #7D7D7D 60%, #00D1FF 100%)",
                "--login-button-bg-color": "#545454",
                "--login-card-bg-color": "#FFFFFF",

                "--header-main-bg-gradient": "linear-gradient(90deg, #545454 0%, #7D7D7D 50%, #00D1FF 100%)",
                "--header-icon-hover": "#00D1FF",
