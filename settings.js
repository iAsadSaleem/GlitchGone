 ...
 **************************************/
    ...
    function buildFeatureLockSection(container) {
        ...
        const agencyMenus = [
            ...
            //Settings menu
            { id: 'sb_agency-profile-settings', title: 'My Profile' },
            { id: 'sb_agency-company-settings', title: 'Company' },
            { id: 'sb_agency-team-settings', title: 'Team' },
            { id: 'sb_agency-twilio-settings', title: 'Phone Integration' },
            { id: 'sb_agency-email-settings', title: 'Email Services' },
            { id: 'sb_system-emails-setting', title: 'System Emails' },
            { id: 'sb_workflow-premium-actions-setting', title: 'Workflow - Premium Features' },
            { id: 'sb_conversation-ai-setting', title: 'AI Employee' },
            { id: 'sb_workflow-ai-setting', title: 'Workflow - External AI Models' },
            { id: 'sb_domain-purchase-setting', title: 'Domain Purchase' },
            { id: 'sb_undefined', title: 'Private Integrations' },
            { id: 'sb_agency-affiliate-settings', title: 'Affiliates' },
            { id: 'sb_agency-custom-link-settings', title: 'Custom Menu Links' },
            { id: 'sb_agency-stripe-settings', title: 'Stripe' },
            { id: 'sb_agency-api-keys-settings', title: 'API Keys' },
            { id: 'sb_agency-compliance-settings', title: 'Compliance' },
            { id: 'sb_agency-labs-settings', title: 'Labs' },
            { id: 'sb_agency-audit-logs-settings', title: 'Audit Logs' }
        ];
