...
(function () {
    ...
    // Wait for fonts to load before removing loader
    function waitForFonts() {
        if (document.fonts && document.fonts.ready) {
            document.fonts.ready.then(() => {
                setTimeout(removeCustomLoader, 300);
            });
        } else {
    ...
    // Method 1: Wait for fonts to load
    waitForFonts();

    // Method 2: Fallback - remove after max 6 seconds
    setTimeout(removeCustomLoader, 6000);
